    ...
    return (
        <ThemeProvider theme={theme === "light" ? lightTheme : darkTheme}>
            ...
            <br />
                                ...
                                <hr />
                                <h3>Manilhas</h3>
                As manilhas não são fixas sempre irá depender do vira
                ...
                <br />
                                ...
                                <hr />
                Mandar cair: a mão passa a valer 3 tentos.
                <br />
                Pedir 6: a mão passa a valer 6 tentos.
                <br />
                Fugir: a dupla que trucou leva 1 tento.
                <br />
                                <hr />
                ...
                <br />
                Pedir 9: a mão passa a valer 9 tentos.
                <br />
                Fugir: a dupla que chamou 6 leva 3 tentos.
                <hr />
                                <h4>Caso a dupla 'A' peça nove : </h4>
                                <hr />
                Mandar cair: a mão passa a valer 9 tentos.
                <br />
                Pedir 12: a mão passa a valer o jogo quem ganhar ganha tudo.
                <br />
                Fugir: a dupla que chamou nove leva 6 tentos.
                <br />
                                <hr />
                ...
                <br />
                Fugir: a dupla que chamou 12 leva 9 tentos
                </p>
                            <hr />
                            <section className="Add-body">
                                ...
                                <section>
                                <button className="btn-ToMain" onClick={toMain}>Voltar para a página de historia</button>
                            </section>
                        </div>
                    </Title>
                </Container>
